...
import "./CryptoBarCoin.sol";

contract CryptoBarCoinPreSale {
    CryptoBarCoin public token;
    ...
    function CryptoBarCoinPreSale(
        CryptoBarCoin _token,
        address _beneficiary,
        address _alfatokenteam
    ) {
        token = CryptoBarCoin(_token);
